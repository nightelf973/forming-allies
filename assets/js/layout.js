    ...
    .then(() => {
      ...
      if (localStorage.getItem("login") === "true") {
        ...
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown">Discussion</a>
        ...
        login.innerHTML = `<li><a class='nav-link active' href='/forming-allies/Account/logout.html'>Logout</a></li>`;
      }
    })
    .catch(error => {
